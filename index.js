...
async function architectWork(trends) {
  ...
  try {
    ...
    const prompt = 'You are the ARCHITECT. Create 25 viral X posts from these topics: ' + JSON.stringify(trends) + '. BTC: $' + btcStr + '. These topics are inspired by @CryptoRover, @MrCryptoWhale, @WatcherGuru, @whale_guru, @whale_insider, @trendingbitcoin and other sources. REQUIREMENTS: 1) 30% of posts should be India-focused 2) Create ORIGINAL takes and commentary - NOT copies of their posts 3) Mix of content types: - 5-6 SHORT posts (200-280 chars, conversational, punchy, NO hashtags) - 5-6 LONG posts (500-600 chars, detailed analysis, WITH hashtags) - 5-6 HUMOROUS posts (witty, relatable crypto humor, engaging) - 8-9 REGULAR posts (balanced, informative, WITH hashtags) 4) Humorous content: crypto jokes, relatable moments, witty observations about Bitcoin 5) Engaging content: questions, conversations starters, community interaction 6) Mix influential quotes (8) and fresh trends 7) Randomize order so types are mixed 8) SHORT posts: NO hashtags, natural conversational style 9) Other posts: use emojis and 3-5 hashtags. Return JSON: [{"post":"text"}]. Only JSON.';
